...
export default function Home() {
  ...
  <div className="group flex min-h-[300px] flex-col rounded-3xl border border-white/10 bg-white/[0.03] p-7 transition duration-300 hover:-translate-y-1 hover:border-cyan-400/30 hover:bg-white/[0.05]">
    ...
    <div className="mt-6 flex flex-wrap gap-2">
      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="overflow-hidden rounded-[2rem] border border-cyan-400/20 bg-gradient-to-br from-cyan-400/10 via-white/[0.03] to-blue-500/10 p-8 sm:p-12 lg:p-16">
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              ...
              <form
                ...
                method="POST"
                className="rounded-3xl border border-white/10 bg-slate-950/60 p-6 backdrop-blur sm:p-8">
                <div className="grid gap-5">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white outline-none transition placeholder:text-slate-600 focus:border-cyan-400/50"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      className="w-full resize-none rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white outline-none transition placeholder:text-slate-600 focus:border-cyan-400/50"
                    />
                  </div>

                  <button
                    type="submit"
                    className="rounded-xl bg-cyan-400 px-6 py-3 font-semibold text-slate-950 transition hover:-translate-y-0.5 hover:bg-cyan-300"
                  >
                    Send Message →
                  </button>
                </div>
