            ...
            <div className="mt-10 space-y-5">
              ...
              <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-6 sm:p-7">
                ...
                <p className="mt-6 text-sm leading-7 text-slate-400">
                  Advanced study in information technology with a focus on
                  artificial intelligence, deep learning, and document
                  processing, including research in Amharic document OCR.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-6 sm:p-7">
                ...
                <p className="mt-6 text-sm leading-7 text-slate-400">
                  Comprehensive foundation in information technology, covering
                  computer systems, networking, databases, software development,
              ...
              <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-6 sm:p-7">
                ...
                <p className="mt-6 text-sm leading-7 text-slate-400">
                  Practical foundation in information technology, covering
                  computer systems, networking, software applications, databases,
                  and IT support.
                </p>
              </div>
            </div>
              ...
              {[
                {
                  name: "CCNA",
                  description:
                    "Networking fundamentals, routing and switching",
                },
                {
                  name: "Cybersecurity",
                  description:
                    "Cybersecurity awareness and security fundamentals",
                },
                {
                ...
                },
                {
                  ...
                  description:
                    "Critical thinking and AI-era problem solving",
                },
              ].map((certificate) => (
                <div
